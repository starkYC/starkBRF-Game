...
- (void)setState:(MJRefreshState)state
{
   ...
   // MJRefreshState oldState = _state;
	...
	switch (state)
    {
        ...
        {
            _statusLabel.text = NSLocalizedString(MJRefreshFooterReleaseToRefresh, nil);
        ...
        {
            _statusLabel.text = NSLocalizedString(MJRefreshFooterPullToRefresh, nil);
        ...
        {
            //_statusLabel.text = NSLocalizedString(@"正在加载更多...", nil);
            _statusLabel.text = NSLocalizedString(MJRefreshFooterRefreshing, nil);
            _arrowImage.transform = CGAffineTransformMakeRotation(M_PI);
            [UIView animateWithDuration:MJRefreshAnimationDuration animations:^{
                UIEdgeInsets inset = _scrollView.contentInset;
